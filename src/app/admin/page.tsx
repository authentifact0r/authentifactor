    ...
    <div className="space-y-6 p-6 md:p-8">
      ...
      <div className="grid gap-3 grid-cols-2 lg:grid-cols-5">
        {[
          ...
          { label: "Stock Units", value: totalStock.toLocaleString(), icon: Box, color: "text-cyan-400 bg-cyan-500/10" },
          { label: "Inventory Value", value: formatPrice(inventoryValue), icon: Banknote, color: "text-violet-400 bg-violet-500/10" },
