        ...
        >
          <div className="flex flex-col md:flex-row">
            ...
            <div className="hidden md:flex w-full md:w-1/2 bg-[#F5F0E8] p-4 items-center">
              <div className="grid grid-cols-3 grid-rows-2 gap-2.5 w-full" style={{ height: "520px" }}>
            ...
            >
              ...
              <div className="mb-6">
                {tenant?.logo ? (
                  <img src={tenant.logo} alt={brandName} className="h-10 w-auto object-contain mb-5" />
                ) : isTenant ? (
                  <h1 className="text-2xl mb-5" style={{ fontFamily: "var(--font-display, Georgia), serif", fontStyle: "italic", color: "#1a1a1a" }}>
                    {brandName}
                  </h1>
                ) : (
                  <Image src="/images/authentifactor-logo.png" alt="Authentifactor" width={150} height={40} className="h-8 w-auto mb-5" />
                )}

                <h2 className="text-xl font-semibold text-[#1a1a1a] mb-1">Create your account</h2>
                <p className="text-sm text-[#777]">
                  {isTenant ? `Join ${brandName} today.` : "Sign up to get started."}
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label htmlFor="reg-firstName" className="block text-sm font-medium text-[#1a1a1a] mb-1.5">First Name</label>
                    <input
                      type="text"
                      id="reg-firstName"
                      value={firstName}
                      ...
                      placeholder="Jane"
                      required
                      className="block w-full rounded-lg border border-gray-300 py-2.5 px-4 text-sm text-[#1a1a1a] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition"
                    />
                  </div>
                  <div>
                    <label htmlFor="reg-lastName" className="block text-sm font-medium text-[#1a1a1a] mb-1.5">Last Name</label>
                    <input
                      type="text"
                      id="reg-lastName"
                      value={lastName}
                ...
                <div>
                  <label htmlFor="reg-email" className="block text-sm font-medium text-[#1a1a1a] mb-1.5">Email Address</label>
                  <input
                    type="email"
                    id="reg-email"
                    value={email}
                ...
                <div>
                  <label htmlFor="reg-phone" className="block text-sm font-medium text-[#1a1a1a] mb-1.5">
                ...
                <div>
                  <label htmlFor="reg-password" className="block text-sm font-medium text-[#1a1a1a] mb-1.5">Password</label>
                  <div className="relative">
                    <input
                      ...
                      required
                      className="block w-full rounded-lg border border-gray-300 py-2.5 px-4 pr-10 text-sm text-[#1a1a1a] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition"
                    />
                    <button
                      type="button"
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex w-full justify-center rounded-lg py-2.5 px-4 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:brightness-110 disabled:opacity-50 disabled:cursor-not-allowed"
                ...
                <button
                  type="button"
                  className="flex w-full items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white py-2.5 px-4 text-sm font-medium text-gray-700 hover:bg-gray-50 transition"
                >
              ...
              <p className="mt-5 text-center text-xs text-gray-400">
                ...
                <Link href="/login" className="font-medium transition" style={{ color: accent }}>Sign in</Link>
              </p>

              {isTenant && (
                <p className="mt-3 text-center text-[9px] text-gray-300 tracking-wide">
